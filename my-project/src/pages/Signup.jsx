    ...
    return (
        <div className="min-h-screen bg-gray-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
                <div className="absolute -top-40 -left-40 w-80 h-80 bg-purple-600/10 rounded-full filter blur-3xl"></div>
                <div className="absolute top-20 -right-40 w-80 h-80 bg-indigo-600/10 rounded-full filter blur-3xl"></div>
            ...
            <div className="relative z-10 sm:mx-auto sm:w-full sm:max-w-md">
                ...
                <p className="mt-2 text-center text-sm text-gray-500">
                    Join PixelAI today and get started
                </p>
            </div>
                ...
                <div className="bg-gray-900/80 backdrop-blur-xl py-8 px-4 shadow-2xl shadow-black/20 border border-gray-800/60 sm:rounded-2xl sm:px-10">
                    <form className="space-y-5" onSubmit={handleSubmit}>
                        ...
                        <div className="flex items-start">
                            <input required type="checkbox" className="h-4 w-4 mt-0.5 text-indigo-600 focus:ring-indigo-500 border-gray-600 rounded bg-gray-800" />
                            <label className="ml-2 block text-sm text-gray-400">
                                I agree to the{" "}
                                <a href="#" className="font-medium text-indigo-400 hover:text-indigo-300 transition-colors">Terms of Service</a>{" "}
                                and{" "}
                                <a href="#" className="font-medium text-indigo-400 hover:text-indigo-300 transition-colors">Privacy Policy</a>
                            </label>
                        </div>
